...
public class EnciclopediaFragmentViewModel extends ViewModel {
    ...
    public EnciclopediaFragmentViewModel(Repository repository) {
    ...
    public LiveData<List<Dinosaurio>> getDinosOpciones(){
        return mRepository.getDinosOpciones();
    }

    public void setFiltro(String opcion){
        mRepository.setFiltro(opcion);
    }
}
